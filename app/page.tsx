            ...
            <div className="container mx-auto flex flex-col items-center justify-center text-center text-white">
              ...
              <div className="mt-10 flex gap-6">
                ...
                onClick={scrollToContact}
                  className="inline-flex h-12 items-center bg-[#000000] justify-center rounded-md border-2 text-[#ffffff] px-8 py-2 text-sm font-medium text-white shadow-lg transition-colors hover:bg-[#ffffff] hover:text-[#000000] focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2"
                >
                  Contact Me
                </div>
              </div>
