...
import { Shield, Zap, Eye, Github, Linkedin, Twitter, Instagram } from 'lucide-react'
              ...
              {projectsData.map((project, index) => (
                ...
                >
                  <Card className="bg-white dark:bg-gray-700 border-red-500 border-2">
                    <CardHeader>
                      <CardTitle id='projects' className="flex items-center text-2xl font-bold text-gray-900 dark:text-white">
            ...
            <div className="flex justify-center space-x-4 mt-8">
              {[Github, Linkedin, Twitter, Instagram].map((Icon, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.8 }}
                  target='blank/'
                  href={ index === 0 ? "https://github.com/manideep1428" : index === 1 ? "https://www.linkedin.com/in/sai-manideep-cherukuri-856b6927a" : index === 2 ? "https://twitter.com/manideep1428" : "https://www.instagram.com/manideep1428/" }
